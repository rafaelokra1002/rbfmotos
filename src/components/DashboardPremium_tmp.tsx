          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="bg-slate-800/40 rounded-2xl p-4 border border-slate-700/50">
                  <p className="text-slate-400 text-xs uppercase font-bold tracking-wider mb-1">Clientes</p>
                  <p className="text-2xl font-bold text-white">{stats.totalClientes}</p>
               </div>
               <div className="bg-slate-800/40 rounded-2xl p-4 border border-slate-700/50">
                  <p className="text-slate-400 text-xs uppercase font-bold tracking-wider mb-1">Motos</p>
